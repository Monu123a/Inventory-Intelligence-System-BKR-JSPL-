...
import { FiBox, FiLayers, FiDatabase, FiAlertCircle, FiTrendingDown, FiBell, FiRefreshCw, FiShoppingCart, FiDollarSign } from 'react-icons/fi';
...
const Overview = () => {
  ...
  if (metricsPending || activityPending || alertsPending) {
    return (
