...
with open('backend/app/services/admin_approvals/executors.py', 'r') as f:
    content = f.read()

update_product_executor = """
...
if "class UpdateProductExecutor(Executor):" not in content:
    content += "\n" + update_product_executor
    with open('backend/app/services/admin_approvals/executors.py', 'w') as f:
        f.write(content)
